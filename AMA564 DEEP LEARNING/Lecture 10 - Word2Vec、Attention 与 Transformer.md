...
## 3.4 Hierarchical Softmax 与 Negative Sampling
...
## 6.1 从一个 attention 到 multi-head attention
...
## 6.3 Residual connection 与 attention block
...
## 7.1 Decoder 的 masked self-attention
