# Lecture 05 - CNN Architectures、Initialization 与 Batch Normalization
...
## 4.3 Feature 2：Overlapping Pooling
...
## 4.4 Overfitting 与 Data Augmentation
...
## 6.2 Skip connection 与 residual mapping
...
## 7.3 He Initialization for ReLU
