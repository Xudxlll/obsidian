...
> - 通过赋值语句保存中间结果，主要变量包括：`im`、`im_flip1`、`im_flip2`、`im_flip3`。
...
> [!abstract] 代码逻辑怎么走
> - 先读取图像，再按本节目标做色彩转换、阈值、形态学或轮廓处理，最后显示结果检查效果。
> - 通过赋值语句保存中间结果，主要变量包括：`im`、`h, w`、`tx`、`ty`、`M`、`im_translated`、`im_translated2`、`im_translated3`。
...
> [!abstract] 代码逻辑怎么走
> - 先读取图像，再按本节目标做色彩转换、阈值、形态学或轮廓处理，最后显示结果检查效果。
> - 通过赋值语句保存中间结果，主要变量包括：`im`、`h, w`、`center`、`angle`、`scale`、`M`、`im_rotated`。
...
> [!abstract] 代码逻辑怎么走
> - 先读取图像，再按本节目标做色彩转换、阈值、形态学或轮廓处理，最后显示结果检查效果。
> - 通过赋值语句保存中间结果，主要变量包括：`im`、`h, w`、`im_resized1`、`im_resized2`、`im_resized3`、`im_resized4`、`im_resized5`。
...
> [!abstract] 代码逻辑怎么走
> - 先读取图像，再按本节目标做色彩转换、阈值、形态学或轮廓处理，最后显示结果检查效果。
> - 通过赋值语句保存中间结果，主要变量包括：`im1`、`im2`、`im_add1`、`im_add2`。
...
> [!abstract] 代码逻辑怎么走
> - 先读取图像，再按本节目标做色彩转换、阈值、形态学或轮廓处理，最后显示结果检查效果。
> - 通过赋值语句保存中间结果，主要变量包括：`im1`、`im2`、`im_sub1`。
...
> [!abstract] 代码逻辑怎么走
> - 先读取图像，再按本节目标做色彩转换、阈值、形态学或轮廓处理，最后显示结果检查效果。
> - 通过赋值语句保存中间结果，主要变量包括：`im`、`kernel`、`im_erode`。
...
> [!abstract] 代码逻辑怎么走
> - 先读取图像，再按本节目标做色彩转换、阈值、形态学或轮廓处理，最后显示结果检查效果。
> - 通过赋值语句保存中间结果，主要变量包括：`im`、`kernel`、`im_dilate`。
...
> [!abstract] 代码逻辑怎么走
> - 先读取图像，再按本节目标做色彩转换、阈值、形态学或轮廓处理，最后显示结果检查效果。
> - 通过赋值语句保存中间结果，主要变量包括：`im1`、`im2`、`kernel`、`o1`、`o2`。
...
> [!abstract] 代码逻辑怎么走
> - 先读取图像，再按本节目标做色彩转换、阈值、形态学或轮廓处理，最后显示结果检查效果。
> - 通过赋值语句保存中间结果，主要变量包括：`im1`、`im2`、`kernel`、`c1`、`c2`。
...
> [!abstract] 代码逻辑怎么走
> - 先读取图像，再按本节目标做色彩转换、阈值、形态学或轮廓处理，最后显示结果检查效果。
> - 通过赋值语句保存中间结果，主要变量包括：`im1`、`kernel`、`o1`、`g1`。
...
> [!abstract] 代码逻辑怎么走
> - 先读取图像，再按本节目标做色彩转换、阈值、形态学或轮廓处理，最后显示结果检查效果。
> - 通过赋值语句保存中间结果，主要变量包括：`im1`、`kernel`、`im_hat1`、`im_open`、`im_hat2`。
...
> [!abstract] 代码逻辑怎么走
> - 先读取图像，再按本节目标做色彩转换、阈值、形态学或轮廓处理，最后显示结果检查效果。
> - 通过赋值语句保存中间结果，主要变量包括：`im1`、`kernel`、`im_hat1`、`im_colse`、`im_hat2`。
